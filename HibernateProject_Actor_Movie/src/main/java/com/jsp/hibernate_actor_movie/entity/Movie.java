...
public class Movie {
	...
	public String getMovieVerdict() {
		return movieVerdict;
	}

	public void setMovieVerdict(String movieVerdict) {
		this.movieVerdict = movieVerdict;
	}
	...
	public String toString() {
		return "Movie [movieId=" + movieId + ", movieTitle=" + movieTitle + ", movieDirector=" + movieDirector
				+ ", movieGenre=" + movieGenre + ", movieVerdict=" + movieVerdict + ", movieCollection="
				+ movieCollection ;
	}
